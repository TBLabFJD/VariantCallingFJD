...
####################################################################################
# Script: Run FJD analysis for mitochondrial samples stored in basespace or locally
# Author: María Torralvo and Lorena de la Fuente 
# Date: 27-07-2020
###################################################################################
...
def main():
	...
	stdoutAll="FJDmito_"+run+".out"
	sys.stdout = open(stdoutAll, 'w', 0)
	stderrAll="FJDmito_"+run+".err"
