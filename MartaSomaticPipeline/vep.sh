...
VCF_IN="48141166_unfiltered.vcf"
VCF_OUT="/home/proyectos/bioinfo/NOBACKUP/mrod/annotated"
#type=$3
VCF_OUT_filtered="${VCF_OUT}_somatic.vcf"
VCF_OUT_filtered_pvm="${VCF_OUT}_somatic.txt"
...
if [ "$type" = "vcf" ]; then
	...
	python $utilitiesPath/vep2tsv_woFreq.py $VCF_OUT_filtered \
	-o $VCF_OUT_filtered_pvm -t -g -f GT,AD,DP
